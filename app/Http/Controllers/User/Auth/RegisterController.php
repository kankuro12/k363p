...
use App\Notifications\VendorUser\SignupActivate;
class RegisterController extends Controller
{
    ...
    public function resend(Request $request){
        ...
        if($user->hasVerifiedEmail()) {
            return redirect('user/login')->withInfo('Your email has already been verified');
        }
        $user->active=0;
        ...
        return redirect('user/login')->with('msg','Verification email resent. Please check your inbox');
    }
}
