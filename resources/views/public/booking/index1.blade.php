...
@section('styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/public/css/checkout.css')}}">
...
@section('content')
    ...
    <div class="checkout-section mt-3">
        <div class="container">
            <div class="row">
                <div class="col-md-8 ">
					<div class="bg-white  p-4 shadow b-round">	
            ...
            <div class="col-md-4 mt-3 mt-md-0 p-md-0 p-3 ">
                <div class="booking-detail-wrapper mr-md-2 ml-md-2 shadow p-4">
                    <div class="d-p-heading">
