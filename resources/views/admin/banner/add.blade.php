    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header">
                <h5> <a href="{{route('admin.banners')}}">Banners</a> / Add Banner</h5>
            </div>
            <div class="card-body">
               <form action="{{route('admin.banners.add')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="link" id="link" class="form-control" placeholder="Enter link like /vendor/ab" required>
                    </div>
                    <hr>
                    <div class="py-2">
                        <h6>
                            <input type="checkbox" value="1" name="show_button" id="show_button" class="mr-2" onchange="
                                if(this.checked){
                    ...
                    <div class="row d-none" id="btn_detail">
                        <div class="col-md-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <input type="file" accept="image/*" name="image" class="dropify" required>
                        </div>
                        <div class="col-md-4">
                            <label for="">for small screen</label>
                            <input type="file" accept="image/*" name="mobile_image" class="dropify" required>
