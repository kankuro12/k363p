...
<div class="login-form">   
    ...
    <form action="{{route('admin.postlogin')}}" method="post">        
        ...
        <div class="form-group">
            <input type="password" class="form-control" name="password" name="password" placeholder="Password" required="required">
        </div>
        <div class="form-group small clearfix">
            <label class="checkbox-inline"><input type="checkbox" name="remember"> Remember me</label>
            <a href="{{route('adminpassword.resetform')}}" class="forgot-link">Forgot Password?</a>
        </div> 
