        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="content">
                    ...
                    <form method="post" action="{{ route('admin.post_create_vendor') }}" id="addVendor"
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="website" class="form-control"
                                            placeholder="Enter website address" value="{{ old('website') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="trpiadvisor_url" class="form-control"
                                            placeholder="Enter trip advisor url" value="{{ old('trpiadvisor_url') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" placeholder="Vendor Description ..."
                                    rows="10" required>{{ old('description') }}</textarea>
                            </div>
                            {{-- <div class="form-group">
                            <label>Average Cost(In Rs.)</label>
                        </div> --}}
                            <input type="hidden" name="average_cost" class="form-control" placeholder="Enter average cost"
                                value="0">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="searchMap" name="location_name" class="form-control mb-2"
